    ...
    <div class="main">
        ...
        <div class="container">
            ...
            <span style='color:red;font-size:30px;float:right;cursor: pointer;' onclick="location.href='http://127.0.0.1:8000/'">&times; </span>
                ...
                @endif
                <h2 class='text-center'>Client Register Page</h2>
                ...
                <!-- <div class="select-list"> -->
                    ...
                    <!-- </div> -->
                    <input type="hidden" name="type" value='user' readonly required />
                    <input type="hidden" name="law_type" value='0' readonly required />
                    <input type="text" name="fname" id="title" placeholder="First name" required />
                    <input type="text" name="lname" id="title" placeholder="Last name" required />
                    ...
                    <input type="number" name="alt_contact" id="phone_number" placeholder="Alternate Phone number" required />
                    <input type="password" name="password" id="password" pattern='.{6,}' title='Password should contain Uppercase, one number and 10 characters' placeholder="Password" required />
                    <div style='position:relative'>
                    ...
                    <textarea type="text" name="address" style='border:none; width:100%; height:200px; border-bottom:2px solid #ebebeb;' id="phone_number" placeholder="Enter full address" required /></textarea>
...
<script>
$(function(){
    $('#email').attr('pattern','[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$');
